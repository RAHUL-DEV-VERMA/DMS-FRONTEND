  ...
  return (
    <>
                    ...
                    <div className="flex">
                      <div className="flex items-center mr-11">
                        <Field
                          ...
                          id="radio-group-1"
                          className="hidden"
                          onClick={() => setFieldValue('communicationMethod', 'email')}
                        />
                        <label htmlFor="radio-group-1" className="flex items-center cursor-pointer text-gray-500 text-base font-normal leading-6">
                          <span className="border border-gray-300 rounded-full mr-2 w-4 h-4"></span> Email
                        </label>
                      </div>
                      <div className="flex items-center">
                        <Field
                          ...
                          id="radio-group-2"
                          className="hidden"
                          onClick={() => setFieldValue('communicationMethod', 'phone')}
                        />
                        <label htmlFor="radio-group-2" className="flex items-center cursor-pointer text-gray-500 text-base font-normal leading-6">
                          <span className="border border-gray-300 rounded-full mr-2 w-4 h-4"></span> Phone
                        </label>
                      </div>
                    </div>
                  </div>
      ...
      <p className="leading-relaxed text-xl text-gray-900 mt-8">
        ...
        <a className="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="https://veilmail.io">
